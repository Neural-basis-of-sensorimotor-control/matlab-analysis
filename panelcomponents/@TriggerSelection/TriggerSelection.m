classdef TriggerSelection < PanelComponent
    ...
    methods
        ...
        function populate(obj,mgr)
            ...
            sc_addlistener(obj,'triggerparent',@triggerparent_listener,obj.uihandle);
            sc_addlistener(obj,'trigger',@trigger_listener,obj.uihandle);
        ...
        function triggerparent_callback(obj)
            ...
            obj.gui.triggerparent = obj.triggerparents.get('tag',str{val});
        ...
        function trigger_callback(obj)
            ...
            obj.gui.trigger = obj.triggers.get('tag',str{val});
            obj.show_panels(false);
        end
        
        function triggerparent_listener(~,~)
            set(obj.ui_trigger,'string',obj.triggerparent.triggers.values('tag'),...
                'visible','on');
            trigger_callback();
        end
        ...
        function updated = update(obj)
            updated = numel(obj.triggertimes) > 0;
        end
    end
end