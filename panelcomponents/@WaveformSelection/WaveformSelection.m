  ...
  methods
    ...
    function initialize(obj)
      if isempty(obj.gui.main_signal)
        obj.gui.waveform = [];
      elseif ~obj.gui.main_signal.waveforms.n
        obj.gui.waveform = [];
      elseif isempty(obj.gui.waveform)
        obj.gui.waveform = obj.gui.main_signal.waveforms.get(1);
      elseif obj.gui.main_signal.waveforms.has('tag', obj.gui.waveform.tag)
        obj.gui.waveform = obj.gui.main_signal.waveforms.get('tag', obj.gui.waveform.tag);
      else
        obj.gui.waveform = obj.gui.main_signal.waveforms.get(1);
      end
