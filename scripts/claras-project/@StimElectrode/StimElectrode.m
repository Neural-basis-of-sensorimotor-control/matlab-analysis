classdef StimElectrode < handle
  ...
  properties (Dependent)
    ...
    time_to_last_indentical_stim
    time_to_last_non_indentical_stim
    time_to_next_stims
  ...
  methods
    ...
    function val = get.time_to_last_indentical_stim(obj)
      ind = cellfun(@(x) strcmp(x, obj.type), StimElectrode.types);
      val = obj.time_to_previous_stims(ind);
    end
    
    function val = get.time_to_last_non_indentical_stim(obj)
      ind = cellfun(@(x) strcmp(x, obj.type), StimElectrode.types);
