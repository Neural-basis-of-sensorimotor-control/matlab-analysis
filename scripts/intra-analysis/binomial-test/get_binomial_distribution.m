function [binomial_distribution, binomial_permutations, nbr_of_positives, ...
  ...
  get_binomial_distribution(neuron, enc_stims, response_min, response_max, ...
  normalize)

[binomial_permutations, nbr_of_positives] = get_binomial_permutations(length(enc_stims));
...
amplitudes = get_items(signal.amplitudes.list, 'tag', enc_stims);
