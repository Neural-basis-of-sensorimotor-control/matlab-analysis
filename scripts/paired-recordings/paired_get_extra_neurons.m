...
data = {
	...
	%'BKNR_SSSA_sc.mat'	'BKNR0002'	'patch'   5.140642e+02	1.202326e+03	{'spike1'         'spike2'}         'Risk för överhörning'   %	5
	%'BKNR_SSSA_sc.mat'	'BKNR0002'	'patch'   5.111576e+02	1.202501e+03	{'spike1'         'ECspike'}        'Överhörning'   %	6
	%'BKNR_SSSA_sc.mat'	'BKNR0002'	'patch'   5.140642e+02	1.202326e+03	{'spike2'         'ECspike'}        'Överhörning'   %	7
	...
	'BPNR_sc.mat'       'BPNR0001'	'patch'   3.332400e-01	4.960155e+02	{'ec-spike-p1-1'  'ic-spike-p1-2'}  'Delat afferent inflöde'   %	11
	...
	'DBNR_sc.mat'       'DBNR0001'	'patch'   9.856540e+00	1.912279e+03	{'spike1-double'  'spike2-double'}  'Asymmetriskt PSTH + överhörning'   %	19
	'DENR_sc.mat'       'DENR0004'	'patch'   2.411000e-02	1.213339e+03	{'spike1-double'  'spike2-double'}  'Delat afferent inflöde, ev asymmetriskt PSTH'   %	20
	'DENR_sc.mat'       'DENR0004'	'patch'   1.072150e+00	1.118984e+03	{'spike1-double'  'spike3-double'}  'Asymmetriskt PSTH'   %	21
	'DENR_sc.mat'       'DENR0004'	'patch'   1.072150e+00	1.118984e+03	{'spike2-double'  'spike3-double'}  'Delat afferent inflöde'   %	22
	...
	'DHNR_sc.mat'       'DHNR0002'	'patch'   8.521000e-02	8.767829e+02	{'spike1-double'  'spike2-double'}  'Delat afferent inflöde, ev asymmetriskt PSTH'   %	26
	'DHNR_sc.mat'       'DHNR0007'	'patch'   8.132000e-02	8.372618e+01	{'spike1-double'  'spike2-double'}  'Asymmetriskt PSTH'   %	27
%	'DHNR_sc.mat'       'DHNR0006'	'patch'   9.450186e+01	1.535355e+03	{'spike1-double'  'spike2-double'}  'Släng bort'   %	28
	'DHNR_sc.mat'       'DHNR0006'	'patch'   1.216400e+01	1.535355e+03	{'spike1-double'  'spike3-double'}  'Asymmetriskt PSTH'   %	29
	'DHNR_sc.mat'       'DHNR0006'	'patch'   9.450186e+01	1.535387e+03	{'spike2-double'  'spike3-double'}  'Delat afferent inflöde'   %	30
...
%	'DJNR_sc.mat'       'DJNR0005'	'patch'   6.867948e+02	1.885877e+03	{'ec-spike-p1-1'  'ec-spike-p1-3'}  'Sannolikt dubbeldetektion'   %	32
	'DJNR_sc.mat'       'DJNR0005'	'patch2'	3.217580e+00	1.661128e+03	{'ic-spike-p2-1'  'ec-spike-p2-1'}  'Delat afferent inflöde, ev asymmetriskt PSTH'   %	33
	'HRNR_sc.mat'       'HRNR0000'	'patch'   2.581220e+00	1.187433e+03	{'ic-spike-p1-1'  'ec-spike-p1-1'}  'Delat afferent inflöde, få spikar'   %	34
%	'HRNR_sc.mat'       'HRNR0000'	'patch2'	1.235465e+01	1.282066e+03	{'ic-spike-p2-1'  'ec-spike-p2-1'}  'Sannolikt dubbeldetektion, få spikar'   %	35
	'HVNR_sc.mat'       'HVNR0001'	'patch'   6.211180e+02	1.285840e+03	{'spike1-double'  'spike2-double'}  'Asymmetriskt PSTH ?'   %	36
	'ICNR_sc.mat'       'ICNR0002'	'patch'   1.226270e+00	1.833655e+03	{'ec-spike-p1-1'  'ic-spike-p1-1'}  'Delat afferent inflöde, ev asymmetriskt PSTH'   %	37
	'IFNR_sc.mat'       'IFNR0000'	'patch'   6.379480e+00	1.166898e+03	{'ec-spike-p1-1'  'ec-spike-p1-2'}  'Asymmetriskt PSTH, men aktiveras före trigger'   %	38
%	'IKNR_sc.mat'       'IKNR0000'	'patch'   1.917470e+00	4.532421e+02	{'ic-spike-p1-1'  'ec-spike-p1-1'}  'Sannolikt dubbeldetektion, få spikar'   %	39
};
