...
while indx1<=len(overlapping_spiketrains)
  ...
  while indx2<=len(overlapping_spiketrains)
    ...
    if (spiketrains_are_equal(tmp_pair_1.neurons(1), tmp_pair_2.neurons(1)) && ...
        spiketrains_are_equal(tmp_pair_1.neurons(2), tmp_pair_2.neurons(2))) || ...
        (spiketrains_are_equal(tmp_pair_1.neurons(1), tmp_pair_2.neurons(2)) && ...
        spiketrains_are_equal(tmp_pair_1.neurons(2), tmp_pair_2.neurons(1)))
