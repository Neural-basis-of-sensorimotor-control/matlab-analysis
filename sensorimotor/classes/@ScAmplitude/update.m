function update(obj, v, dt, psp_templates, response_min, response_max, remove_fraction)
...
obj.rise = sc_get_amplitude_pseudo_rise(obj.start, obj.stop, ...
	obj.is_pseudo, obj, v);
sc_get_automatic_xpsp_detected(obj, v, dt,  psp_templates, response_min, response_max);
